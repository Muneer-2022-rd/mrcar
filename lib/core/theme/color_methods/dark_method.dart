...
NavigationBarThemeData navigationBarThemeDataDarkMethod(Color color) {
...
CardTheme cardThemeDarkMethod(Color color) {
  return CardTheme(
...
InputDecorationTheme inputDecorationThemeDarkMethod(
...
ChipThemeData chipThemeDataDarkMethod(Color color) {
...
CheckboxThemeData checkboxThemeDataDarkMethod(Color color) {
...
ElevatedButtonThemeData elevatedButtonThemeDataDarkMethod(Color color) {
